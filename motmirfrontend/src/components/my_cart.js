    ...
    <section className="myCartSection">
      ...
      <div className="cartItemsContainer">
        ...
        <div className="tableFooter">
          ...
          <button onClick={() => setShowOrder(true)}>Order Now</button>
        </div>
      </div>
      {showOrder && totalQuantity && secureGetToken() ? <Order setShowOrder={setShowOrder} cart={cart} setCart={setCart} totalQuantity={totalQuantity} totalPrice={totalPrice}/> : <></>}
    </section>
  )
}
